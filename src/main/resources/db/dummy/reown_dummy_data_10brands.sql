...
(1,1,'NUE 오버핏 아카이브 블레이저','https://picsum.photos/seed/reown-product-1/600/800',129000,700,2,'NORMAL','ON_SALE',1,'2026-05-02 10:01:00'),
(2,1,'NUE 미니멀 코튼 셔츠','https://picsum.photos/seed/reown-product-2/600/800',59000,300,3,'NORMAL','ON_SALE',2,'2026-05-02 10:02:00'),
(3,1,'NUE 와이드 턱 팬츠','https://picsum.photos/seed/reown-product-3/600/800',79000,500,3,'NORMAL','ON_SALE',3,'2026-05-02 10:03:00'),
(4,1,'NUE 리버시블 니트 베스트','https://picsum.photos/seed/reown-product-4/600/800',69000,350,2,'FUNDING','ON_SALE',4,'2026-05-02 10:04:00'),
(5,2,'LUMIERE 실키 드레이프 원피스','https://picsum.photos/seed/reown-product-5/600/800',118000,420,2,'NORMAL','ON_SALE',5,'2026-05-02 10:05:00'),
(6,2,'LUMIERE 크롭 트위드 자켓','https://picsum.photos/seed/reown-product-6/600/800',149000,600,2,'NORMAL','ON_SALE',6,'2026-05-02 10:06:00'),
(7,2,'LUMIERE 새틴 블라우스','https://picsum.photos/seed/reown-product-7/600/800',76000,280,3,'NORMAL','ON_SALE',7,'2026-05-02 10:07:00'),
(8,2,'LUMIERE 플리츠 미디 스커트','https://picsum.photos/seed/reown-product-8/600/800',89000,370,3,'FUNDING','ON_SALE',8,'2026-05-02 10:08:00'),
(9,3,'RAW EDGE 워시드 데님 자켓','https://picsum.photos/seed/reown-product-9/600/800',98000,720,2,'NORMAL','ON_SALE',9,'2026-05-02 10:09:00'),
(10,3,'RAW EDGE 그래픽 후드티','https://picsum.photos/seed/reown-product-10/600/800',72000,650,3,'NORMAL','ON_SALE',10,'2026-05-02 10:10:00'),
(11,3,'RAW EDGE 카고 버뮤다 팬츠','https://picsum.photos/seed/reown-product-11/600/800',83000,520,3,'NORMAL','ON_SALE',11,'2026-05-02 10:11:00'),
(12,3,'RAW EDGE 빈티지 메신저백','https://picsum.photos/seed/reown-product-12/600/800',64000,450,2,'FUNDING','ON_SALE',12,'2026-05-02 10:12:00'),
(13,4,'SLOW THREAD 리사이클 코트','https://picsum.photos/seed/reown-product-13/600/800',189000,950,1,'NORMAL','ON_SALE',13,'2026-05-02 10:13:00'),
(14,4,'SLOW THREAD 오가닉 스웨트셔츠','https://picsum.photos/seed/reown-product-14/600/800',68000,520,3,'NORMAL','ON_SALE',14,'2026-05-02 10:14:00'),
(15,4,'SLOW THREAD 린넨 밴딩 팬츠','https://picsum.photos/seed/reown-product-15/600/800',74000,430,3,'NORMAL','ON_SALE',15,'2026-05-02 10:15:00'),
(16,4,'SLOW THREAD 업사이클 토트백','https://picsum.photos/seed/reown-product-16/600/800',52000,310,2,'FUNDING','ON_SALE',16,'2026-05-02 10:16:00'),
(17,5,'MODERN HANGUL 자음 그래픽 티셔츠','https://picsum.photos/seed/reown-product-17/600/800',43000,240,4,'NORMAL','ON_SALE',17,'2026-05-02 10:17:00'),
(18,5,'MODERN HANGUL 한글 패턴 셔츠','https://picsum.photos/seed/reown-product-18/600/800',69000,320,3,'NORMAL','ON_SALE',18,'2026-05-02 10:18:00'),
(19,5,'MODERN HANGUL 자수 볼캡','https://picsum.photos/seed/reown-product-19/600/800',39000,150,4,'NORMAL','ON_SALE',19,'2026-05-02 10:19:00'),
(20,5,'MODERN HANGUL 타이포 니트','https://picsum.photos/seed/reown-product-20/600/800',97000,480,2,'FUNDING','ON_SALE',20,'2026-05-02 10:20:00'),
(21,6,'DAILY FORM 데일리 후드 집업','https://picsum.photos/seed/reown-product-21/600/800',62000,610,4,'NORMAL','ON_SALE',21,'2026-05-02 10:21:00'),
(22,6,'DAILY FORM 베이직 롱슬리브','https://picsum.photos/seed/reown-product-22/600/800',36000,250,5,'NORMAL','ON_SALE',22,'2026-05-02 10:22:00'),
(23,6,'DAILY FORM 스트레이트 데님','https://picsum.photos/seed/reown-product-23/600/800',69000,560,3,'NORMAL','ON_SALE',23,'2026-05-02 10:23:00'),
(24,6,'DAILY FORM 나일론 크로스백','https://picsum.photos/seed/reown-product-24/600/800',48000,280,3,'FUNDING','ON_SALE',24,'2026-05-02 10:24:00'),
(25,7,'ODD ATELIER 언밸런스 자켓','https://picsum.photos/seed/reown-product-25/600/800',158000,670,2,'NORMAL','ON_SALE',25,'2026-05-02 10:25:00'),
(26,7,'ODD ATELIER 레이어드 탑','https://picsum.photos/seed/reown-product-26/600/800',82000,310,3,'NORMAL','ON_SALE',26,'2026-05-02 10:26:00'),
(27,7,'ODD ATELIER 컷아웃 슬랙스','https://picsum.photos/seed/reown-product-27/600/800',108000,510,2,'NORMAL','ON_SALE',27,'2026-05-02 10:27:00'),
(28,7,'ODD ATELIER 구조적 미니백','https://picsum.photos/seed/reown-product-28/600/800',86000,360,2,'FUNDING','ON_SALE',28,'2026-05-02 10:28:00'),
(29,8,'MONO GROUND 블랙 싱글 코트','https://picsum.photos/seed/reown-product-29/600/800',169000,900,2,'NORMAL','ON_SALE',29,'2026-05-02 10:29:00'),
(30,8,'MONO GROUND 화이트 셔츠','https://picsum.photos/seed/reown-product-30/600/800',54000,290,4,'NORMAL','ON_SALE',30,'2026-05-02 10:30:00'),
(31,8,'MONO GROUND 테이퍼드 팬츠','https://picsum.photos/seed/reown-product-31/600/800',73000,480,3,'NORMAL','ON_SALE',31,'2026-05-02 10:31:00'),
(32,8,'MONO GROUND 미니멀 백팩','https://picsum.photos/seed/reown-product-32/600/800',99000,520,2,'FUNDING','ON_SALE',32,'2026-05-02 10:32:00'),
(33,9,'VERT LINE 라이트 윈드브레이커','https://picsum.photos/seed/reown-product-33/600/800',99000,430,3,'NORMAL','ON_SALE',33,'2026-05-02 10:33:00'),
(34,9,'VERT LINE 테크 유틸리티 베스트','https://picsum.photos/seed/reown-product-34/600/800',88000,360,2,'NORMAL','ON_SALE',34,'2026-05-02 10:34:00'),
(35,9,'VERT LINE 조거 팬츠','https://picsum.photos/seed/reown-product-35/600/800',79000,470,3,'NORMAL','ON_SALE',35,'2026-05-02 10:35:00'),
(36,9,'VERT LINE 리사이클 버킷햇','https://picsum.photos/seed/reown-product-36/600/800',42000,140,4,'FUNDING','ON_SALE',36,'2026-05-02 10:36:00'),
(37,10,'SEASONLESS 울 블렌드 자켓','https://picsum.photos/seed/reown-product-37/600/800',148000,680,2,'NORMAL','ON_SALE',37,'2026-05-02 10:37:00'),
(38,10,'SEASONLESS 프리미엄 터틀넥','https://picsum.photos/seed/reown-product-38/600/800',67000,340,3,'NORMAL','ON_SALE',38,'2026-05-02 10:38:00'),
(39,10,'SEASONLESS 세미와이드 슬랙스','https://picsum.photos/seed/reown-product-39/600/800',82000,500,3,'NORMAL','ON_SALE',39,'2026-05-02 10:39:00'),
(40,10,'SEASONLESS 레더 미니백','https://picsum.photos/seed/reown-product-40/600/800',119000,410,2,'FUNDING','ON_SALE',40,'2026-05-02 10:40:00');
