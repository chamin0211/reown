                  ...
                  VIP
                    ...
                    {tierProgress}% more to VVIP
                        ...
                        {buyingCount}
                                ...
                                {/* Funding History */}
                                <button
                                    onClick={() => handleMenuClick('/my/funding')}
                                    className="w-full group"
                                >
                                    <div
                                        className="flex items-center justify-between hover:opacity-70 transition-opacity">
                                        <div className="flex items-center gap-3">
                                            <Ticket className="w-4 h-4" style={{color: '#101828'}}/>
                                            <div className="text-left">
                                                <div className="text-sm font-light" style={{color: '#101828'}}>
                                                    Funding History
                                                </div>
                                                <div className="text-xs font-light text-gray-500 mt-0.5">
                                                    My funding participations
                                                </div>
                                            </div>
                                        </div>
                                    </div>
